...
entities) {
    return __awaiter(this, void 0, void 0, function () {
        var mockDB, driver, metadataBuilder, entityMetadataValidator, queryRunner, entityMetadatas, _i, entityMetadatas_1, metadata, table, _a, entityMetadatas_2, metadata, table, foreignKeys, _b, entityMetadatas_3, metadata, view, sql, memorySql;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 13:
                    ...
                    memorySql.upQueries.forEach(function (query) {
                        sql += query.query + ";\n";
                    });
