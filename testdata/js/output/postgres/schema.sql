-- atlas:pos author[type=table] [ABS_PATH]/entities/blog/Author.js:1:16-10:2
-- atlas:pos blog[type=table] [ABS_PATH]/entities/Blog.js:2:21-11:2
-- atlas:pos category[type=table] [ABS_PATH]/entities/Category.js:2:35-14:2
-- atlas:pos post[type=table] [ABS_PATH]/entities/post/Post.js:2:21-25:2

CREATE TABLE "post" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "text" text NOT NULL, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"));
...
CREATE TABLE "blog" ("id" SERIAL NOT NULL, CONSTRAINT "PK_85c6532ad065a448e9de7638571" PRIMARY KEY ("id"));
CREATE TABLE "author" ("id" SERIAL NOT NULL, CONSTRAINT "PK_5a0e79799d372fe56f2f3fa6871" PRIMARY KEY ("id"));
